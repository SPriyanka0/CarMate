...
<head>
    ...
    <div class="container">
        ...
        if(isset($_POST["login"])){
            ...
            $sql = "SELECT * FROM users WHERE email = '$email' "; //data matches from email from database to user entered email
            ...
            if($user){
                ...
                if(password_verify($password, $user['password'])){
                    ...
                    session_start();
                    $_SESSION["user"] = "yes"; 
                    header("Location: user_home.php"); //redirects to homepage
                    die();
                }else{
        ...
        <div>
            ...
            <p>Admin <a href="admindash.php">Login</a></p>
            <p>Dragstrip <a href="dragstrip_login.php">Login</a></p>
             </div>
    </div>
</head>
<body>
