...
<head>
    ...
    <title>CarMate Dragstrip Login</title>
    <!-- bootstrap cdn -->
    ...
    <div class="container">
        ...
        if(isset($_POST["dragstrip_login"])){
            //if button clicked then collect data
            $email = $_POST["email"];
            $password = $_POST["password"];
            //if data exists
            require_once "database.php";
            $sql = "SELECT * FROM dragstrip_login WHERE email = '$email' "; //data matches from email from database to user entered email
        ...
        <h1>Car Mate Dragstrip Login</h1>
